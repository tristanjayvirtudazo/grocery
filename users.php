                                ...
                                <div class="form-group">
									...
									<div class="col-sm-9">
                                        <select class="form-control" name="branch_name" id="branch_name">
                                            <option value="Blk 7 lot 7 SSB Brigade">Blk 7 lot 7 SSB Brigade</option>
                                            <option value="141 Balatan st.">141 Balatan st.</option>
                                            <option value="16 Dalandan st.">16 Dalandan st.</option>
                                        </select>
