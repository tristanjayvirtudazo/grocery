...
$fetchCatQuery = "SELECT categories.categories_id, categories.categories_name FROM categories";
$itemResult = $connect->query($fetchCatQuery);
$editBrand = $connect->query($fetchCatQuery);
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-warning button1" data-toggle="modal" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Brand </button>
				</div> <!-- /div-action -->
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" id="editCategory" name="editCategory">
									<option id="editCategoryOption" value=""></option>
								</select>
							</div>
						</div> <!-- /form-group-->
