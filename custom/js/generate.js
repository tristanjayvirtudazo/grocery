...
const revealQR = () => {
    ...
    $('#qr_field').attr('hidden', false)

    $.ajax({
        type: 'POST',
        url: 'php_action/generateQR.php',
        data: {name: data},
        success: function(response) {
            $('#qr_image').attr('src','assests/images/QrCodes/'+response)
            $('#qr_exporter').attr('href','assests/images/QrCodes/'+response)
        },
        error: function(e) {
            console.log(e)
        }
