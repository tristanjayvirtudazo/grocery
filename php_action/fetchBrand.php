...
$sql = "SELECT brands.brand_id, brands.brand_name, brands.brand_active, brands.brand_status, categories.categories_name FROM brands
		INNER JOIN categories ON categories.categories_id = brands.category
